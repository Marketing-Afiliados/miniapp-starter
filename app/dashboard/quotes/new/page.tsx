...
export default async function NewQuotePage() {
  ...
  return (
    <div>
      ...
      <div className="mt-8">
        <QuoteEditor catalogCategories={catalog.categories} catalogItems={catalog.catalogItems} currency={business.currency} customers={customers ?? []} defaultMargin={business.default_margin_percentage} defaultTerms={business.default_terms ?? ""} materials={materials ?? []} preferredCategoryIds={catalog.preferredCategoryIds} services={services ?? []} />
      </div>
    </div>
  );
}
