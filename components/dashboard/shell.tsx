    ...
    <div className="min-h-screen bg-slate-50">
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur lg:hidden">
        ...
        <div className="border-t border-slate-100 px-3 py-2">
          ...
          {!admin ? (
            <Link className="mt-6 flex min-h-11 items-center justify-center rounded-xl bg-violet-600 px-4 text-sm font-semibold text-white shadow-sm shadow-violet-200 transition hover:bg-violet-700" href="/dashboard/quotes/new">
              + Nueva cotización
            </Link>
          ) : null}
        </div>
