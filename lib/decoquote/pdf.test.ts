...
describe("generateQuotePdf", () => {
  it("genera un PDF comercial válido sin etiquetas privadas", async () => {
    ...
    const business = { id: "b", user_id: "u", business_name: "Magics Eventos", owner_name: "Andrea López", email: "hola@example.com", phone: null, whatsapp: "+593999999999", instagram: "@magics", logo_url: null, address: "Quito", currency: "USD", default_margin_percentage: 40, default_terms: null, created_at: now, updated_at: now } as BusinessProfile;
